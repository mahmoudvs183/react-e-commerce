...
export default function Main() {
    return (
        <Box justifyContent="end" className="main-box">
            <Container className="main-box-container">
                <img className="main-photo" src="/Rectangle10.png" alt="" />
                <Stack display="flex" justifyContent="space-between" alignItems="start" width="410px" position="absolute" sx={{ top: "10%", left: "0", height: "80%" }} textAlign="center" color="#000">
